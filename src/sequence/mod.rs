...
impl Data {
    ...
    pub fn new_public(operations_pk: PublicKey, actor: ActorType, name: XorName, tag: u64, signatory: Signatory) -> Self {
        Self {
            operations_pk,
            data: SeqData::Public(PublicSeqData::new(actor, Address::Public { name, tag }, signatory)),
        }
    }
    ...
    pub fn new_private(
        ...
        Self {
            operations_pk,
            data: SeqData::Private(PrivateSeqData::new(actor, Address::Private { name, tag }, signatory)),
        }
    }
