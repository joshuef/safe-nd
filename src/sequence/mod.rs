...
mod tests {
    ...
    fn sequence_public_set_policy_and_apply() -> Result<()> {
        ...
        let _ = perms2.insert(SequenceUser::Key(actor1), user_perms2);
        ...
        assert_eq!(first_entry.owner, actor1);
        ...
        assert_eq!(
            ...
            replica1.permissions_at(SequenceUser::Key(actor1), index_1, None)?
        );
    ...
    fn sequence_concurrent_policy_ops() -> Result<()> {
        ...
        let owner_op_1 = replica1.set_public_policy(generate_keypair().public_key(), perms.clone())?;
        let owner_op_2 = replica2.set_public_policy(generate_keypair().public_key(), perms)?;
        ...
        fn proptest_we_converge_with_ownership_changes(
            ...
            for (data, policy_change_chance) in dataset {
                    ...
                    if policy_change_chance < u8::MAX / 3 {
                        let new_owner = generate_keypair().public_key();
